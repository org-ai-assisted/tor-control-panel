...
## Text-only helpers -- NO PyQt import, so the config-logic modules
## (torrc_gen etc.) can use these strings without a GUI dependency. The PyQt
## help dialogs live in info_gui.py.
